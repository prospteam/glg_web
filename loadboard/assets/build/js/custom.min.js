function init_sidebar() {
    ...
    $SIDEBAR_MENU.find("a").on("click", function(a) {
        ...
        t.parent().find("li ul").slideUp()) : ($SIDEBAR_MENU.find("li").removeClass("active active-sm"),
...
function init_flot_chart() {
    if (void 0 !== $.plot) {
        ...
        for (var e = [[gd(2012, 1, 1), 17], [gd(2012, 1, 2), 74], [gd(2012, 1, 3), 6], [gd(2012, 1, 4), 39], [gd(2012, 1, 5), 20], [gd(2012, 1, 6), 85], [gd(2012, 1, 7), 7]], a = [[gd(2012, 1, 1), 82], [gd(2012, 1, 2), 23], [gd(2012, 1, 3), 66], [gd(2012, 1, 4), 9], [gd(2012, 1, 5), 119], [gd(2012, 1, 6), 6], [gd(2012, 1, 7), 9]], t = [], o = [[0, 1], [1, 9], [2, 6], [3, 10], [4, 5], [5, 17], [6, 6], [7, 10], [8, 7], [9, 11], [10, 35], [11, 9], [12, 12], [13, 5], [14, 3], [15, 4], [16, 9]], n = 0; n < 30; n++)
...
function init_cropper() {
    if (void 0 !== $.fn.cropper) {
        ...
        $(".docs-toggles").on("change", "input", function() {
            ...
            e.data("cropper") && ("checkbox" === i ? (c[n] = o.prop("checked"),
        ...
        $(".docs-buttons").on("click", "[data-method]", function() {
            ...
            if (!n.prop("disabled") && !n.hasClass("disabled") && e.data("cropper") && i.method) {
                ...
                switch (o = e.cropper(i.method, i.option, i.secondOption),
                i.method) {
                case "scaleX":
                case "scaleY":
                ...
                case "getCroppedCanvas":
                    o && ($("#getCroppedCanvasModal").modal().find(".modal-body").html(o),
                    a.hasClass("disabled") || a.attr("href", o.toDataURL()))
                }
                if ($.isPlainObject(o) && t)
                    try {
        ...
        var d, u = $("#inputImage"), m = window.URL || window.webkitURL;
        m ? u.change(function() {
            var a, t = this.files;
            e.data("cropper") && t && t.length && (a = t[0],
            /^image\/\w+$/.test(a.type) ? (d = m.createObjectURL(a),
            e.one("built.cropper", function() {
                m.revokeObjectURL(d)
            }).cropper("reset").cropper("replace", d),
...
function init_knob() {
    if (void 0 !== $.fn.knob) {
        ...
        var e, a = 0, t = 0, o = 0, n = $("div.idir"), i = $("div.ival"), r = function() {
            o++,
            n.show().html("+").fadeOut(),
            i.html(o)
        }, l = function() {
...
function init_calendar() {
    if (void 0 !== $.fn.fullCalendar) {
        ...
        var e, a, t = new Date, o = t.getDate(), n = t.getMonth(), i = t.getFullYear(), r = $("#calendar").fullCalendar({
            customButtons: {
                app_next: {
                    text: "Hehe",
                    click: function() {
            ...
            events: [{
                ...
                title: "Long Event",
                start: new Date(i,n,o - 5),
                end: new Date(i,n,o - 2)
            }, {
                title: "Meeting",
                start: new Date(i,n,o,10,30),
                allDay: !1
            }, {
                title: "Lunch",
                start: new Date(i,n,o + 14,12,0),
                end: new Date(i,n,o,14,0),
                allDay: !1
            }, {
                title: "Birthday Party",
                start: new Date(i,n,o + 1,19,0),
                end: new Date(i,n,o + 1,22,30),
                allDay: !1
            }, {
...
!function(e, a) {
    var t = function(e, a, t) {
        ...
        return function() {
            ...
            var i = this
              , r = arguments;
            o ? clearTimeout(o) : t && e.apply(i, r),
            o = setTimeout(n, a || 100)
        }
    };
