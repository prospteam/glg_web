           ...
           <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="x_panel">
                 <div class="x_title">
                    ...
                    <!-- <a href="'.base_url('loads') .'/delete_load/'.$rows->load_id.'" class="btn btn-default mr-1 btn-xs delete_load" >Delete My Load</a> -->
                    <div class="clearfix"></div>
                 </div>
                 <div class="x_content">
           ...
           <div class="modal-content modal-content-custom">
              ...
              <form method="post">
                 <div class="modal-body">
                   ...
                   <select class="form-control input-lg select_shipper" name="carrier_id" style="margin: auto; width: 90%;">
                   </select>
                   <!-- </div> -->
                 </div>
