   ...
   <div class="">
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               <div class="x_title">
                  <h2>New Load Information <small></small></h2>
                  <div class="clearfix"></div>
              </div>
              <div class="x_content">
                  <form id="demo-form" data-parsley-validate method="post">
                     <div class="row">
                        <div class="col-md-6 col-sm-12 ">
                           <div class="col-md-6 col-sm-12 col-xs-12">
                              ...
                              <input type="text" id="origin" class="form-control" name="origin" required />
                              <br>
                           </div>
                           <div class="col-md-6 col-sm-12 col-xs-12">
                           ...
                           <div class="col-md-12 col-sm-12 col-xs-12">
                              <label style="width: 100%;" for="size">Size
                                 <div class="form-group">
                                    <div class="col-md-12 col-xs-12 col-sm-12" style="padding: 0px 0px;">
                                       <div class="form-group">
                                          <label for="a-name" class="control-label" style="padding: 0;">Length (ft): </label>
                                          <div class="" style="padding: 0; font-weight: normal;">
                                             <input id="a-name" class="form-control" type="number" name="length">
                                          </div>
                                       </div>
                                    </div>
                                    <div class="col-md-12 col-xs-12 col-sm-12" style="padding: 0px 0px;">
                                       <div class="form-group">
                                          ...
                                          <div class="" style="padding: 0; font-weight: normal;">
                                             <input id="d-name" class="form-control " type="number" name="weight">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                              ...
                              <div class="col-md-4 col-sm-12 col-xs-12">
                                 ...
                                 <input type="number" id="reference" class="form-control" name="reference"  />
                                 <br>
                              </div>
                              <div class="" style="padding: 0px 10px;">
                                 <label class="label_custom" for="fullname">Comments</label>
                                 <textarea id="fullname" class="form-control" name="comments"></textarea>
                                 <br>
                              </div>
                           </div>
                        </div>
                     ...
                     <div style="margin-top: 25px; text-align: center;">
                        <button style="font-size: 15px; padding: 12px 30px;" name="submit_load" class="btn btn-primary">Add Load</button>
                     </div>
                 </form>
               </div>
            </div>
