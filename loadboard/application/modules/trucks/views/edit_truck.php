<!-- </?php echo "<pre>";print_r($truck);exit; ?> -->
<!-- </?php echo "<pre>";print_r($truck->trailer_type);exit; ?> -->
<!-- page content -->
   ...
   <div class="">
      ...
      <div class="row">
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
               <div class="x_title">
                  <h2>Edit Truck Information <small></small></h2>
                  <div class="clearfix"></div>
              </div>
              <div class="x_content">
                  <form id="edit-truck-form" data-parsley-validate method="post">
                     <div class="row">
                        <div class="col-md-6 col-sm-12 col-xs-12">
                           <div class="col-md-6 col-sm-12">
                              ...
                              <input type="text" id="origin" class="form-control" name="origin" value="<?php echo $truck->origin.", ".$truck->origin_state.", USA"; ?>" required />
                              <br>
                           </div>
                           <div class="col-md-6 col-sm-12">
                              <label class="label_custom" for="">Destination</label>
                              <input type="text" class="form-control" name="destination" id="destination" value="<?php echo $truck->destination.", ".$truck->destination_state.", USA"; ?>" required />
                              <br>
                           </div>
                           ...
                           <div class="col-md-12 col-sm-12">
                              <label for="trailer_type" class="label_custom" style="display:grid;">Trailer Type
                                 <select id="trailer_type" name="trailer_type" style="font-weight: normal;">
                                    <option value="<?php echo $truck->trailer_type; ?>" selected><?php echo $truck->trailer_type; ?></option>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                              <div class="" style="padding: 0px 10px">
                                 ...
                                 <input type="date" id="ddatepicker" class="form-control" name="date" value="<?php echo $truck->date_available; ?>" required />
                                 <br>
                              </div>
                              <div class="" style="padding: 0px 10px;">
                                 <label class="label_custom" for="fullname">Comments</label>
                                 <textarea id="fullname" class="form-control" name="comments"><?php echo $truck->comments; ?></textarea>
                                 <br>
                              </div>
                           </div>
                        </div>
                     ...
                     <div style="margin-top: 25px; text-align: center;">
                         <button style="font-size: 15px; padding: 12px 30px;" name="submit_edited_truck" class="btn btn-primary edit_truck">Update</button>
                     </div>
                 </form>
               </div>
            </div>
